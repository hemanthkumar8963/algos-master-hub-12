          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-2xl font-semibold text-foreground">Hello! I'm Hemanth Kumar Somana</h3>
              </div>
            ...
            <div className="relative">
              <div className="w-80 h-80 mx-auto bg-gradient-to-br from-blue-900 to-purple-900 rounded-full flex items-center justify-center">
